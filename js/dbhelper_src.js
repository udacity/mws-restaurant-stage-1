...
class DBHelper {
  ...
  static dbPromise = idb.open('restaurant-details', 1, (upgradeDb)=>{
    switch(upgradeDB.oldVersion){
      case 0:
        var restaurantStore = upgradeDb.createObjectStore('restaurant-details', 'restaurantID');
  ...
  static addRecord = (restaurantID, restaurantDetails)=>{
    return this.dbPromise.then((db)=>{
      ...
      listStore.put(Object.assign(restaurantDetails, {restaurantID: restaurantID}))
      return tx.complete;
    })
  }
  ...
  // TODO: Store all restaurants when they are first called
  /**
